...
from AngelMusic.utils.decorators.admins import ActualAdminCB
from AngelMusic.utils.decorators.language import language, languageCB
from AngelMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from AngelMusic.utils.inline.start import private_panel
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery, _):
    ...
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        return await CallbackQuery.edit_message_text(
            _["mstart_2"].format(CallbackQuery.from_user.mention, app.mention),
            reply_markup=InlineKeyboardMarkup(buttons),
        )
    else:
        buttons = setting_markup(_)
